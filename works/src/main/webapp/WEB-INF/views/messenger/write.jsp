      ...
      <main>
        <div id="sidebar">
          ...
          <div id="messenger-status">
            <a href="http://127.0.0.1:8080/messenger/unread">
              <div><button>안읽음</button></div>
            </a>
            <a href="http://127.0.0.1:8080/messenger/important">
              <div><button>중요</button></div>
            </a>
            <a href="http://127.0.0.1:8080/messenger/trash">
              <div><button>휴지통</button></div>
            </a>
          </div>
          <hr>
          <div id="all-messenger">
            <a href="http://127.0.0.1:8080/messenger/all">
              <p>전체쪽지</p>
            </a>
          </div>
          <div id="receive-messenger">
            <a href="http://127.0.0.1:8080/messenger/received">
              <p>받은쪽지</p>
            </a>
          </div>
          <div id="send-messenger">
            <a href="http://127.0.0.1:8080/messenger/sent">
              <p>보낸쪽지</p>
            </a>
          </div>
        </div>
              ...
              <div id="messenger-infor-receiver">
                ...
                <select id="receiver-select">
                  ...
                  <c:forEach var="employee" items="${employeeList}">
                    <!-- &nbsp; 이건 공백을 넣을 때 사용한다. -->
                    <option value="${employee.no}" name="receiverEmpNo" class="click-option">
                      ${employee.name}&nbsp;&nbsp;&nbsp;${employee.positionNo}&nbsp;&nbsp;&nbsp;${employee.deptNo}
                    </option>
                  </c:forEach>
                </select>
