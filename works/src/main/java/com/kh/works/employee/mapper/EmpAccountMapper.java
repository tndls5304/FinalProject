...
public interface EmpAccountMapper {
    ...
    @Select("""
            SELECT E.NO,E.EMAIL,E.NAME,E.ID,E.PROFILE,E.PHONE,E.HIRE_DATE,E.RETIRE_YN,E.RETIRE_DATE,E.LOGIN_FAIL_NUM,E.LOCK_YN,E.DEPT_NO,E.POSITION_NO,D.NAME AS DEPT_NAME,P.NAME AS POSITION_NAME
                        FROM EMPLOYEE E
